import { Head, Ctx, ErrorComponent, useMutation } from "blitz"
import { RoomType } from "db"
import addReservation from "app/reservations/mutations/addReservation"
import React from "react"
import Button from "@mui/material/Button"
import roomAvailability from "app/reservations/queries/roomAvailability"
    ...
    <div>
      ...
      <BootstrapDialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
        <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose}>
          Book Room No. {props.data.number}
